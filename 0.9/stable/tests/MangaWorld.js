...
//#endregion
//#region src/MangaWorld/pbconfig.ts
...
//#endregion
//#region src/MangaWorld/main.ts
	const DOMAIN = "https://www.mangaworld.mx";
	var MangaWorldExtension = class extends MangaWorldGeneric {
		constructor() {
			super({
				domain: DOMAIN,
				name: pbConfig.name,
	...
	const MangaWorld = new MangaWorldExtension();
