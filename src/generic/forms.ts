...
class FavSettings extends Form {
    ...
    public async updateToggleValue(
        value: boolean,
        filter: string,
    ): Promise<void> {
        Application.setState(value, filter);
            ...
            Section(
                ...
                [
                    ToggleRow("fav_section_enabled", {
                        ...
                        subtitle:
                            "Puoi impostare i generi tramite l'impostazione sotto",
            ...
            Section(
                ...
                [
                    ToggleRow("popular_section_enabled", {
                        ...
                        onValueChange: Application.Selector(
                            this as HomeSettings,
                            "handlePopularStatusChange",
                        ),
                    }),
